...
type ForbiddenAiInputBuilderKeys =
  | "note"
  | "notes"
  | "rawNote"
  | "fullNote"
...
type NoForbiddenKeys<T> = IsNever<Extract<keyof T, ForbiddenAiInputBuilderKeys>>;

type ExactKeys<T, AllowedKeys extends PropertyKey> = IsNever<
  Exclude<keyof T, AllowedKeys>
>;

type _BuilderAcceptsComparisonInputs = AssertTrue<
  IsAssignable<Parameters<typeof buildCompareExplanationInput>[0], ComparisonInput[]>
>;

type _BuilderReturnsCompareExplanationInput = AssertTrue<
  IsAssignable<ReturnType<typeof buildCompareExplanationInput>, CompareExplanationInput>
>;

type _ListingBuilderAcceptsComparisonInput = AssertTrue<
  IsAssignable<
    Parameters<typeof buildCompareExplanationListingInput>[0],
    ComparisonInput
  >
>;

type _ListingBuilderReturnsCompareExplanationListingInput = AssertTrue<
  IsAssignable<
    ReturnType<typeof buildCompareExplanationListingInput>,
    CompareExplanationListingInput
  >
>;
